from model.CNN_LSTM_GAT import cnn_lstm_attention_gat,get_data
import datetime
...
import numpy as np
savepath = "/home/zhaoxiaohui/20210927_v3/model_save/lr_{}_ep_200000_naiveatt_fc/model_epo_{}_loss_{}_acc_{}_new.pkl"
jspath = "/home/zhaoxiaohui/20210927_v3/model_save/train_log/model_lr_0.0001_naiveatt_epo_{}_noval_fc.json"
...
if __name__ == '__main__':
    cnn_inputs,static_tensor,idx_train,idx_val,idx_test,y = get_data()
    ...
    for epoch in  range(epochs):
        ...
        tg.train()
        out,_,_ ,adj= tg(cnn_inputs,static_tensor)
        optimizer.zero_grad()
